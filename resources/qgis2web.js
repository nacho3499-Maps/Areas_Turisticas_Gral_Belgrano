...
map.getView().fit([-7380513.540749, -3588216.924994, -7377852.717507, -3586296.809436], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Areas turisticas General Belgrano</h2>';
        return titleElement;
    })(),
